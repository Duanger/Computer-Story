...
{
    [AddComponentMenu("Event/Computer Input Module")]
    /// <summary>
    ...
    /// </remarks>
    //[RequireComponent(typeof(DieBaseInput))]
    public class ComputerInputModule : PointiosInputModule
    {
        ...
        [SerializeField] private StandaloneInputModule m_defaultInputModule;
        ...
        public override void UpdateModule()
        {
            ...
            m_MousePosition = DieCursor.current.mousePossy;
        }
        ...
        public override void ActivateModule()
        {
            ...
            base.ActivateModule();
            m_MousePosition = DieCursor.current.mousePossy;
            m_LastMousePosition = DieCursor.current.mousePossy;
        ...
        protected void ProcessTouchPress(PointerEventData pointerEvent, bool pressed, bool released)
        {
            ...
            if (pressed)
            {
                ...
                pointerEvent.position = DieCursor.current.mousePossy;
        ...
        {
            m_defaultInputModule.enabled = true;
            base.OnDisable();
        }
    }
}